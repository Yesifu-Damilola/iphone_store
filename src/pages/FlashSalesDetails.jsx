...
// import { ProductLink } from "./../components/productComponent/ProductLink";
...
// export const FlashSalesDetails = () => {
//   const { data: productid } = useGetSingleProduct();
...
//             // src={productid.image}
//             alt={productid.title}
//             onClick={() => setSelectedImage(productid)}
//             className="w-[121px] h-[114px]"
//           /> */}
//         </div>
//         <div className="flex flex-col items-center justify-center bg-red-400 w-full h-auto md:h-[600px] rounded px-2 ">
//           {/* <img
...
//               </div>
//               <p className="text-2xl/6 text-left">{productid?.price}</p>
