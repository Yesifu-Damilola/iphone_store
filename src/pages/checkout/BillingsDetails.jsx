...
//           type="text"
//           className="w-full md:max-w-[470px] p-2 bg-gray-100 rounded-md focus:outline-none"
//         />
...
//         />
//         <div className="w-5 h-5 border border-gray-300 rounded bg-white peer-checked:bg-red-500 peer-checked:border-transparent flex items-center justify-center">
...
//       <button
//         type="submit"
//         className="w-full md:max-w-[470px] bg-blue-600 text-white py-3 px-4 rounded-md hover:bg-blue-700 transition-colors focus:outline-none"
//       >
//         Complete Order
//       </button>
//     </div> */}
